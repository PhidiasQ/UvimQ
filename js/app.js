(() => {
    ...
    let formValidate = {
        ...
        validateInput(formRequiredItem) {
            ...
            if ("phone" === formRequiredItem.dataset.required) {
                formRequiredItem.value = formRequiredItem.value.replace(" ", "");
        ...
        emailTest(formRequiredItem) {
            return !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formRequiredItem.value);
        }
    };
    ...
    function initSliders() {
        if (document.querySelector(".book__slider")) new core(".book__slider", {
            ...
            navigation: {
                ...
                nextEl: ".swiper-button-next",
                disabledClass: "swiper-button-disabled",
                navigationDisabledClass: "swiper-button-next-disabled"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    if (document.querySelector(".body-reviews__slider")) new core(".body-reviews__slider", {
        modules: [ Navigation, Pagination ],
        observer: true,
        observeParents: true,
        slidesPerView: 3,
    ...
    DynamicAdapt.prototype.arraySort = function(arr) {
        if ("max" === this.type) arr.sort((function(a, b) {
    ...
    for (let i = 0; i < sliderImages.length; i++) {
        ...
        sliderImages[i].parentElement.appendChild(zoomIcon);
        zoomIcon.addEventListener("click", (function() {
            if (sliderImages[i].classList.contains("zoomed")) {
                sliderImages[i].classList.remove("zoomed");
                sliderImages[i].style.transform = "scale(1)";
            } else {
                for (let j = 0; j < sliderImages.length; j++) if (sliderImages[j].classList.contains("zoomed")) {
                    sliderImages[j].classList.remove("zoomed");
                    sliderImages[j].style.transform = "scale(1)";
                }
                sliderImages[i].classList.add("zoomed");
                sliderImages[i].style.transform = "scale(1.5)";
            }
        }));
    }
